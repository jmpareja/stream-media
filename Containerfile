...
RUN mkdir -p common/src catalog-service/src streaming-service/src gateway/src \
...
RUN touch common/src/lib.rs catalog-service/src/main.rs streaming-service/src/main.rs gateway/src/main.rs
